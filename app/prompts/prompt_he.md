...
3. ברגע שיש לוח זמנים + אזור + חדרים → "תודה! קיבלנו את הפרטים, אעביר אותך לאחד הסוכנים שעובדים בפרויקט זה. מקווה שיחזרו אליך תוך יום עסקים." → handoff_to_human=true
