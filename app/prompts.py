...
1. פתיחה ואפיון הצרכים: קבל את הלקוח בברכת שלום אדיבה. שאל לשמו של הלקוח וברר איתו בעדינות ובנפרד (אל תציף בכל השאלות בבת אחת): אזור מבוקש, גודל/מספר חדרים, ודרישות חשובות מהרשימה: מרפסת, ממ"ד, חניה, מחסן, נוף, או קרבה למקומות כמו בתי כנסת וסופרים.
