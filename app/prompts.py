...
1. פתיחה ואפיון הצרכים: קבל את הלקוח בברכת שלום אדיבה. סדר השאלות (שאל אחת-אחת, דלג על מה שכבר נאמר):
   א. אזור מבוקש (השאלה הראשונה תמיד!)
   ב. גודל/מספר חדרים
   ג. דרישות חשובות: מרפסת, ממ"ד, חניה, מחסן, נוף, או קרבה למקומות כמו בתי כנסת וסופרים
   ד. תקציב (אחרון, בנימה נעימה): אחרי שקיבלת את כל הדרישות, שאל בנימה נעימה: "האם יש לך תקציב מסוים שאתה מתכנן להשקיע?" — אם הלקוח לא רוצה לציין, זה בסדר, תעבור לאיסוף פרטים
