...
1. פתיחה ואפיון הצרכים:
   - אם הלקוח פונה על פרויקט ספציפי (למשל "ראיתי את השלט שלכם על פרויקט הנגיד") → ענה: "שלום וברכה, נותרו לנו מספר דירות בפרויקט [שם הפרויקט], אשמח לשמוע ממך קצת יותר פרטים כדי שאוכל למקד אותך. כמה חדרים את מחפש?" והמשך שאל דרישות.
