...
_NOT_RELEVANT = ["לא רלוונטי", "לא מעוניין", "לא רלוונט", "לא מתעניין", "לא צריך", "לא רוצה", "not relevant", "not interested", "הסר", "remove", "unsubscribe", "stop", "אין צורך", "לא רלוונטי לי", "לא רלוונט לי", "לא רלוונטי עבורי", "לא רלוונט עבורי", "לא רלוונטי עבורנו", "no thanks", "no thank you", "not for me", "לא תודה", "לא, תודה", "תודה לא", "לא מעניין", "לא רלוונטי כרגע", "לא עכשיו תודה", "כרגע לא", "לא כרגע"]
